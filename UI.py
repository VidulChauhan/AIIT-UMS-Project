...
#############################################################         ADMIN SIDE        ###########################################################
    ...
    def adminhome():  # COMPLETED #############################################
        ...
        global f3
        f3 = fr(win, bd=0, height=100, width=1150,
                bg='#232323')  # smaller one OVER F2
        f3.place(relx=0.5, rely=0, anchor='center')

        l28 = lb(f3, text=DATE, bd=0, font=(
            'SF Pro Display', 13), bg='#232323', fg='#FFFFFF')
        ...
        b6 = bt(f3, image=p10, bd=0, bg='#232323',
                activebackground='#232323', command=main)
        b6.place(relx=0.95, rely=0.75, anchor='center')
        ANIMATE(b6, p10)

        global f4
        f4 = fr(f2, height=520, width=875, bd=0,
                bg='#000000')  # OVER F2 BELOW F3
        f4.place(relx=0.5, rely=0.535, anchor='center')

        b7 = bt(f4, image=p11, bd=0, bg='#000000',
                activebackground='#000000', command=sprofile)  # profile
        b7.place(relx=0.1385, rely=0.236, anchor='center')
        ANIMATE(b7, p11)

        b8 = bt(f4, image=p12, bd=0, bg='#000000',
                activebackground='#000000', command=assignments)  # assignments
        b8.place(relx=0.466, rely=0.688, anchor='center')
        ANIMATE(b8, p12)

        b9 = bt(f4, image=p14, bd=0, bg='#000000',
                activebackground='#000000', command=projects)  # projects
        b9.place(relx=0.392, rely=0.182, anchor='center')
        ANIMATE(b9, p14)

        b10 = bt(f4, image=p18, bd=0, bg='#000000',
                 activebackground='#000000', command=marks)  # marks
        b10.place(relx=0.7515, rely=0.182, anchor='center')
        ANIMATE(b10, p18)

        b11 = bt(f4, image=p16, bd=0, bg='#000000',
                 activebackground='#000000', command=attendance)  # attendance
        b11.place(relx=0.13855, rely=0.62, anchor='center')
        ANIMATE(b11, p16)

        b12 = bt(f4, image=p15, bd=0, bg='#000000',
                 activebackground='#000000', command=events)  # events
        b12.place(relx=0.13855, rely=0.8825, anchor='center')
        ANIMATE(b12, p15)

        b13 = bt(f4, image=p19, bd=0, bg='#000000',
                 activebackground='#000000', command=passr)  # passreset
        b13.place(relx=0.738, rely=0.52, anchor='center')
        ANIMATE(b13, p19)

        b14 = bt(f4, image=p17, bd=0, bg='#000000',
                 activebackground='#000000', command=about)  # about
        b14.place(relx=0.912, rely=0.52, anchor='center')
        ANIMATE(b14, p17)

        b15 = bt(f4, image=p13, bd=0, bg='#000000',
                 activebackground='#000000', command=fee_details)  # fee
        b15.place(relx=0.8263, rely=0.828, anchor='center')
        ANIMATE(b15, p13)

        b16 = bt(f3, image=p20, bd=0, bg='#232323',
                 activebackground='#232323', command=adminhome)  # adminhome button
        b16.place(relx=0.5, rely=0.75, anchor='center')
        ANIMATE(b16, p20)

        b39 = bt(f2, image=p35, bd=0, bg='#000000',
                 activebackground='#000000', command=addadmin)  # add administrator
        b39.place(relx=0.01, rely=0.115, anchor='w')
        ANIMATE(b39, p35)

        b40 = bt(f2, image=p36, bd=0, bg='#000000',
                 activebackground='#000000', command=addstudent)  # add student
        b40.place(relx=0.01, rely=0.175, anchor='w')
        ANIMATE(b40, p36)

        def delstudent():
            lb(f2, image=p50, bd=0).place(
                relx=0.9375, rely=0.5, anchor='center')

            global dsid  # 0.235 ---> rely
            dsid = ent(f2, bd=0, bg='#FFFFFF', font=(
                'SF Pro Display', 12), width=6)  # ID
            ...
            def del1():
                ...
                if (dsid.get() != '' and dsid.get() != 'Enter ID') and ((dsid.get(),) not in d20):
                    ...
                    if (a == 0) and ((dsid.get(),) in d20):
                        try:
                            dbcur.execute(
                                'delete from sprofile where sid="{}"'.format(dsid.get()))
                            dbcur.execute(
                                'delete from marks where sid="{}"'.format(dsid.get()))
                            dbcur.execute(
                                'delete from slogin where id="{}"'.format(dsid.get()))
                            dbcur.execute(
                                'delete from projects where sid="{}"'.format(dsid.get()))
                            dbcur.execute(
                                'delete from attendance where sid="{}"'.format(dsid.get()))
                            dbcur.execute(
                                'delete from fees where sid="{}"'.format(dsid.get()))
                            dbcur.execute(
        ...
        def deladmin():
            ...
            global daid
            daid = ent(f2, bd=0, bg='#FFFFFF', font=(
                'SF Pro Display', 12), width=6)  # ID
        ...
        b57 = bt(f2, image=p48, bd=0, bg='#000000',
                 activebackground='#000000', command=deladmin)
        b57.place(relx=0.99, rely=0.115, anchor='e')
        ANIMATE(b57, p48)

        b58 = bt(f2, image=p49, bd=0, bg='#000000',
                 activebackground='#000000', command=delstudent)
        ...
        l12 = lb(f3, text='Student ID ', font=('SF Pro Display', 13),
                 bd=0, bg='#232323', fg='#FFFFFF')
        l12.place(relx=0.275, rely=0.75, anchor='center')

        global sid
        sid = ent(f3, bd=0, font=('SF Pro Display', 13),
                  width=6)  # sid for profile
    ...
    def addstudent():  # COMPLETED  ###############################################################
        ...
        l6 = lb(f12, text='Add Student account', font=(
            'SF Pro Display', 38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
                        ...
                        try:
                            dbcur.execute("insert into sprofile values('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')"
                                          .format(
                                              ...
                                              s6.get()))
                            dbcur.execute(
                                "insert into marks values('{}','NULL','NULL','NULL','NULL','NULL','NULL','NULL','NULL')".format(s12.get()))
                            dbcur.execute(
                                'insert into slogin values("{}","NULL")'.format(s12.get()))
                            dbcur.execute(
                                'insert into fees values("{}","NULL","NULL","NULL","NULL")'.format(s12.get()))
                            dbcur.execute(
                                'insert into projects values("{}","NULL,NULL","NULL,NULL","NULL,NULL","NULL,NULL","NULL,NULL")'.format(s12.get()))
                            dbcur.execute(
                                'insert into attendance values("{}","NULL")'.format(s12.get()))
                            dbcur.execute(
        ...
        b42 = bt(f12, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                 fg='#CF3327', activebackground='#000000', command=adminhome)
    ...
    def addadmin():  # COMPLETED ###########################################################
        ...
        l6 = lb(f13, text='Add Administrator account', font=(
            'SF Pro Display', 38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
        l6.place(relx=0, rely=0.05, anchor='w')
        ...
        l85 = lb(f13, text='ID', bd=0, font=(
            'SF Pro Display', 15), bg='#232323', fg='#249ADF')
        l85.place(relx=0.2, rely=0.3, anchor='w')

        l85 = lb(f13, text='Phone number :', bd=0, font=(
            'SF Pro Display', 16), bg='#232323', fg='#249ADF')
        l85.place(relx=0.2, rely=0.4, anchor='w')

        l86 = lb(f13, text='New password :', bd=0, font=(
            'SF Pro Display', 16), bg='#232323', fg='#249ADF')
        l86.place(relx=0.2, rely=0.5, anchor='w')

        l87 = lb(f13, text='Confirm new password :', bd=0, font=(
            'SF Pro Display', 16), bg='#232323', fg='#249ADF')
        ...
        tid = ent(f13, bd=0, bg='#F2F2F2', font=(
            'SF Pro Display', 16), width=10)
        tid.place(relx=0.475, rely=0.3, anchor='w')

        phno = ent(f13, bd=0, bg='#F2F2F2', font=(
            'SF Pro Display', 16), width=10)  # ph
        phno.place(relx=0.475, rely=0.4, anchor='w')

        napass = ent(f13, bd=0, bg='#F2F2F2', font=(
            'SF Pro Display', 16), width=10)  # new
        napass.place(relx=0.475, rely=0.5, anchor='w')

        cnapass = ent(f13, bd=0, bg='#F2F2F2', font=(
            'SF Pro Display', 16), width=10)  # new confirmed
        ...
        b44 = bt(f13, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                 fg='#CF3327', activebackground='#000000', command=adminhome)
    ...
    def forgpass():  # COMPLETED  #############################################################
        ...
        l38 = lb(f8, text='Forgot password', font=(
            'SF Pro Display', 38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
        ...
        l41 = lb(f8, text='Enter ID :', bd=0, font=(
            'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
        ...
        def go():
            ...
            if (fid.get(),) in d2:
                dbcur.execute(
                    'select * from adminlogin where id="{}"'.format(fid.get()))
                d3 = dbcur.fetchall()[0]
                Pn = '******'+d3[2][6:]
                t.sleep(0.5)
                ...
                phone = ent(f8, bd=0, font=('SF Pro Display', 16),
                            width=10, bg='#F2F2F2')
                phone.place(relx=0.525, rely=0.5, anchor='center')

                l44 = lb(f8, text='Enter phone number :', bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
                ...
                b29 = bt(f8, text='Send', bd=0, font=('SF Pro Display', 16),
                         bg='#232323', fg='#249ADF', activebackground='#232323', command=send)
                b29.place(relx=0.7, rely=0.55, anchor='center')

                l45 = lb(f8, text='Enter One Time Password', bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
                ...
                otp = ent(f8, bd=0, font=('SF Pro Display', 16),
                          width=6, bg='#F2F2F2')
                ...
                def fverify():
                    ...
                    if len(scount) != 0:
                        ...
                        if otp.get() == str(onet):
                            ...
                            l48 = lb(f9, text='Set New password', font=(
                                'SF Pro Display', 38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
                            l48.place(relx=0, rely=0.05, anchor='w')

                            l49 = lb(f9, text='Enter new password :', font=(
                                'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
                            l49.place(relx=0.15, rely=0.2, anchor='w')

                            l50 = lb(f9, image=p33, bd=0)
                            l50.place(relx=0.475, rely=0.2, anchor='center')

                            npass = ent(f9, bd=0, font=(
                                'SF Pro Display', 16), width=10, bg='#F2F2F2')
                            npass.place(relx=0.475, rely=0.2, anchor='center')

                            l51 = lb(f9, text='Confirm password :', font=(
                                'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
                            ...
                            cnpass = ent(f9, bd=0, font=(
                                'SF Pro Display', 16), width=10, bg='#F2F2F2')
                            cnpass.place(relx=0.475, rely=0.35,
                                         anchor='center')
                            ...
                            b31 = bt(f9, image=p52, font=('SF Pro Display', 16), bd=0, bg='#000000',
                                     activebackground='#000000', fg='#CF3327', command=cancel2)
                            ...
                            b32 = bt(f9, text='Save', font=('SF Pro Display', 16), bd=0,
                                     bg='#232323', activebackground='#232323', fg='#249ADF', command=save2)
                ...
                b30 = bt(f8, text='Verify', font=('SF Pro Display', 16), bd=0,
                         fg='#249ADF', bg='#232323', activebackground='#232323', command=fverify)
        ...
        b27 = bt(f8, text='Go', bd=0, font=('SF Pro Display', 16),
                 bg='#232323', fg='#249ADF', activebackground='#232323', command=go)
        b27.place(relx=0.6, rely=0.3, anchor='center')

        b28 = bt(f8, image=p52, bd=0, font=('SF Pro Display', 16), bg='#000000',
                 fg='#CF3327', activebackground='#000000', command=cancel1)
    ...
    def passr():  # COMPLETED  #############################################################
        def apassreset():
            global l32
            l32 = lb(f7, text='Current password :', bd=0, font=(
                'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
            l32.place(relx=0.2, rely=0.3, anchor='w')

            l33 = lb(f7, text='New password :', bd=0, font=(
                'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
            l33.place(relx=0.2, rely=0.4, anchor='w')

            l34 = lb(f7, text='Confirm new password :', bd=0, font=(
                'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
            ...
            curpass = ent(f7, bd=0, bg='#F2F2F2', font=(
                'SF Pro Display', 16), width=10)  # cur
            curpass.place(relx=0.475, rely=0.3, anchor='w')

            newpass = ent(f7, bd=0, bg='#F2F2F2', font=(
                'SF Pro Display', 16), width=10)  # new
            newpass.place(relx=0.475, rely=0.4, anchor='w')

            cnewpass = ent(f7, bd=0, bg='#F2F2F2', font=(
                'SF Pro Display', 16), width=10)  # new confirmed
            ...
            def apass_save():
                dbcur.execute(
                    'select * from adminlogin where id="{}"'.format(aid.get()))
                d4 = dbcur.fetchall()[0]
                try:
                    if curpass.get() == '':
                        msgb.showwarning(
            ...
            b26 = bt(f7, text='Save', bd=0, font=('SF Pro Display', 15), bg='#232323',
                     fg='#249ADF', activebackground='#232323', command=apass_save)
        ...
        def spassreset():
            ...
            l54 = lb(f7, text='New password :', bd=0, font=(
                'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
            l54.place(relx=0.2, rely=0.4, anchor='w')

            l55 = lb(f7, text='Confirm new password :', bd=0, font=(
                'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')
            ...
            Sid = ent(f7, bd=0, bg='#F2F2F2', font=(
                'SF Pro Display', 16), width=10)  # current
            Sid.place(relx=0.475, rely=0.3, anchor='w')

            newspass = ent(f7, bd=0, bg='#F2F2F2', font=(
                'SF Pro Display', 16), width=10)  # new
            newspass.place(relx=0.475, rely=0.4, anchor='w')

            cnewspass = ent(f7, bd=0, bg='#F2F2F2', font=(
                'SF Pro Display', 16), width=10)  # new confirmed
            ...
            b26 = bt(f7, text='Save', bd=0, font=('SF Pro Display', 15), bg='#232323',
                     fg='#249ADF', activebackground='#232323', command=spass_save)
            b26.place(relx=0.7, rely=0.6, anchor='center')
        ...
        l31 = lb(f7, text='Password reset', font=('SF Pro Display',
                                                  38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
        l31.place(relx=0, rely=0.05, anchor='w')

        b23 = bt(f7, image=p30, bd=0, bg='#232323',
                 activebackground='#232323', command=apassreset)
        b23.place(relx=0.499, rely=0.175, anchor='e')
        ANIMATE(b23, p30)

        b24 = bt(f7, image=p32, bd=0, bg='#232323',
                 activebackground='#232323', command=spassreset)
    ...
    def sprofile():  # COMPLETED   ##################################################
        ...
        for i in d1:
            if sid.get() == i[0]:
                ...
                l6 = lb(f5, text='Profile', font=('SF Pro Display',
                                                  38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
                l6.place(relx=0, rely=0.05, anchor='w')

                dbcur.execute(
                    'select * from sprofile where sid="{}"'.format(sid.get()))
                d6 = dbcur.fetchall()
                rec = d6[0]
                ...
                l14 = lb(f5, text='{}'.format(rec[2]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # sname
                l14.place(relx=0.29, rely=0.29, anchor='w')

                l15 = lb(f5, text='{}'.format(rec[5]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # student ph
                l15.place(relx=0.29, rely=0.383, anchor='w')

                l16 = lb(f5, text='{}'.format(rec[9]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # year
                l16.place(relx=0.29, rely=0.475, anchor='w')

                l17 = lb(f5, text='{}'.format(rec[1]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # admission number
                l17.place(relx=0.6925, rely=0.29, anchor='w')

                l18 = lb(f5, text='{}'.format(rec[8]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # course
                l18.place(relx=0.6925, rely=0.383, anchor='w')

                l19 = lb(f5, text='{}'.format(rec[0]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # id
                l19.place(relx=0.5425, rely=0.473, anchor='w')

                l20 = lb(f5, text='{}'.format(rec[11]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # blood group
                l20.place(relx=0.825, rely=0.473, anchor='w')

                l21 = lb(f5, text='{}'.format(rec[3]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # fname
                l21.place(relx=0.29, rely=0.688, anchor='w')

                l22 = lb(f5, text='{}'.format(rec[6]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # father ph
                l22.place(relx=0.29, rely=0.782, anchor='w')

                l23 = lb(f5, text='{}'.format(rec[4]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # mname
                l23.place(relx=0.78, rely=0.688, anchor='w')

                l24 = lb(f5, text='{}'.format(rec[7]), bd=0, font=(
                    'SF Pro Display', 16), bg='#232323', fg='#FFFFFF')  # mother ph
                l24.place(relx=0.78, rely=0.782, anchor='w')

                l25 = lb(f5, text='{}'.format(rec[10].capitalize()), bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # gender
                ...
                def profile_edit():
                    ...
                    lb(f5, image=p33, bd=0).place(
                        relx=0.29, rely=0.29, anchor='w')
                    sname_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # for student name
                    sname_e.place(relx=0.298, rely=0.29, anchor='w')
                    sname_e.insert(0, rec[2])

                    lb(f5, image=p33, bd=0).place(
                        relx=0.29, rely=0.383, anchor='w')
                    sph_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # for student mobile
                    sph_e.place(relx=0.298, rely=0.383, anchor='w')
                    sph_e.insert(0, rec[5])

                    lb(f5, image=p33, bd=0).place(
                        relx=0.29, rely=0.475, anchor='w')
                    y_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # for current year
                    y_e.place(relx=0.298, rely=0.475, anchor='w')
                    y_e.insert(0, rec[9])

                    lb(f5, image=p33, bd=0).place(
                        relx=0.6925, rely=0.29, anchor='w')
                    admn_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # for student admission
                    admn_e.place(relx=0.7005, rely=0.29, anchor='w')
                    admn_e.insert(0, rec[1])

                    l18.place_forget()
                    lb(f5, image=p33, bd=0).place(
                        relx=0.6925, rely=0.383, anchor='w')
                    crs_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # for course
                    crs_e.place(relx=0.7005, rely=0.383, anchor='w')
                    crs_e.insert(0, rec[8])

                    lb(f5, image=p44, bd=0).place(
                        relx=0.825, rely=0.473, anchor='w')
                    bld_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=4)  # for blood group
                    bld_e.place(relx=0.833, rely=0.473, anchor='w')
                    bld_e.insert(0, rec[11])

                    l25.place_forget()
                    lb(f5, image=p44, bd=0).place(
                        relx=0.095, rely=0.5, anchor='center')
                    gdr_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 13), width=6)  # for gender
                    gdr_e.place(relx=0.095, rely=0.5, anchor='center')
                    gdr_e.insert(0, rec[10])

                    lb(f5, image=p33, bd=0).place(
                        relx=0.29, rely=0.688, anchor='w')
                    fname_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # for father's name
                    fname_e.place(relx=0.298, rely=0.688, anchor='w')
                    fname_e.insert(0, rec[3])

                    lb(f5, image=p33, bd=0).place(
                        relx=0.29, rely=0.782, anchor='w')
                    fph_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # father's number
                    fph_e.place(relx=0.298, rely=0.782, anchor='w')
                    fph_e.insert(0, rec[6])

                    lb(f5, image=p33, bd=0).place(
                        relx=0.78, rely=0.688, anchor='w')
                    mname_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # for mother's name
                    mname_e.place(relx=0.788, rely=0.688, anchor='w')
                    mname_e.insert(0, rec[4])

                    lb(f5, image=p33, bd=0).place(
                        relx=0.78, rely=0.782, anchor='w')
                    mph_e = ent(f5, bd=0, bg='#F2F2F2', font=(
                        'SF Pro Display', 14), width=13)  # mother's number
                    ...
                    b18 = bt(f5, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                             fg='#249ADF', activebackground='#000000', command=profile_save)
                    b18.place(relx=0.95, rely=0.1, anchor='center')
                    ANIMATE(b18, p51)

                    b19 = bt(f5, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                             fg='#CF3327', activebackground='#000000', command=sprofile)
                    b19.place(relx=0.85, rely=0.1, anchor='center')
                    ANIMATE(b19, p52)

                b17 = bt(f5, image=p28, bd=0, bg='#000000',
                         activebackground='#000000', command=profile_edit)
    ...
    def marks():  # COMPLETED   ##################################################
        ...
        if (sid.get(),) in d13:
            ...
            l59 = lb(f10, text='Mark details', font=('SF Pro Display',
                                                     38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
            ...
            dbcur.execute(
                'select * from marks where sid="{}"'.format(sid.get()))
            d10 = dbcur.fetchall()
            rec1 = list(d10[0])
            ...
            if rec1[1] != 'NULL':
                l61 = lb(f10, text=rec1[1], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # mid sem 1
                l61.place(relx=0.53, rely=0.315, anchor='center')

                l62 = lb(f10, text=(
                    rec1[1]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l62.place(relx=0.82, rely=0.315, anchor='center')
            else:
                l77 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')  # mid sem 1
                l77.place(relx=0.53, rely=0.315, anchor='center')

                l78 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')
                l78.place(relx=0.82, rely=0.315, anchor='center')

            if rec1[2] != 'NULL':
                l63 = lb(f10, text=rec1[2], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # sem final 1
                l63.place(relx=0.53, rely=0.375, anchor='center')

                l64 = lb(f10, text=(
                    rec1[2]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l64.place(relx=0.82, rely=0.375, anchor='center')
            else:
                l79 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')  # sem final 1
                l79.place(relx=0.53, rely=0.375, anchor='center')

                l80 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')
                l80.place(relx=0.82, rely=0.375, anchor='center')

            if rec1[3] != 'NULL':
                l65 = lb(f10, text=rec1[3], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # midsem 2
                l65.place(relx=0.53, rely=0.465, anchor='center')

                l66 = lb(f10, text=(
                    rec1[3]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l66.place(relx=0.82, rely=0.465, anchor='center')
            else:
                l65 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')  # midsem 2
                l65.place(relx=0.53, rely=0.465, anchor='center')

                l66 = lb(f10, text=('N/A'), bd=0,
                         font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l66.place(relx=0.82, rely=0.465, anchor='center')

            if rec1[4] != 'NULL':
                l67 = lb(f10, text=rec1[4], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # final 2
                l67.place(relx=0.53, rely=0.525, anchor='center')

                l68 = lb(f10, text=(
                    rec1[4]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l68.place(relx=0.82, rely=0.525, anchor='center')
            else:
                l67 = lb(f10, text=('N/A'), bd=0, font=('SF Pro Display',
                                                        15), bg='#232323', fg='#FFFFFF')  # final 2
                l67.place(relx=0.53, rely=0.525, anchor='center')

                l68 = lb(f10, text=('N/A'), bd=0,
                         font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l68.place(relx=0.82, rely=0.525, anchor='center')

            if rec1[5] != 'NULL':
                l69 = lb(f10, text=rec1[5], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # midsem 3
                l69.place(relx=0.53, rely=0.615, anchor='center')

                l70 = lb(f10, text=(
                    rec1[5]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l70.place(relx=0.82, rely=0.615, anchor='center')
            else:
                l69 = lb(f10, text=('N/A'), bd=0, font=('SF Pro Display',
                                                        15), bg='#232323', fg='#FFFFFF')  # midsem 3
                l69.place(relx=0.53, rely=0.615, anchor='center')

                l70 = lb(f10, text=('N/A'), bd=0,
                         font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l70.place(relx=0.82, rely=0.615, anchor='center')

            if rec1[6] != 'NULL':
                l71 = lb(f10, text=rec1[6], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # final 3
                l71.place(relx=0.53, rely=0.675, anchor='center')

                l72 = lb(f10, text=(
                    rec1[6]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l72.place(relx=0.82, rely=0.675, anchor='center')
            else:
                l71 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')  # final 3
                l71.place(relx=0.53, rely=0.675, anchor='center')

                l72 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')
                l72.place(relx=0.82, rely=0.675, anchor='center')

            if rec1[7] != 'NULL':
                l73 = lb(f10, text=rec1[7], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # midsem 4
                l73.place(relx=0.53, rely=0.765, anchor='center')

                l74 = lb(f10, text=(
                    rec1[7]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l74.place(relx=0.82, rely=0.765, anchor='center')
            else:
                l73 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')  # midsem 4
                l73.place(relx=0.53, rely=0.765, anchor='center')

                l74 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')
                l74.place(relx=0.82, rely=0.765, anchor='center')

            if rec1[8] != 'NULL':
                l75 = lb(f10, text=rec1[8], bd=0, font=(
                    'SF Pro Display', 15), bg='#232323', fg='#FFFFFF')  # final 4
                l75.place(relx=0.53, rely=0.825, anchor='center')

                l76 = lb(f10, text=(
                    rec1[8]+'%'), bd=0, font=('SF Pro Display', 15), bg='#232323', fg='#FFFFFF')
                l76.place(relx=0.82, rely=0.825, anchor='center')
            else:
                l75 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')  # final 4
                l75.place(relx=0.53, rely=0.825, anchor='center')

                l76 = lb(f10, text='N/A', bd=0, font=('SF Pro Display',
                                                      15), bg='#232323', fg='#FFFFFF')
                l76.place(relx=0.82, rely=0.825, anchor='center')
            ...
            def marks_edit():
                ...
                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.315, anchor='center')
                e1 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e1.place(relx=0.53, rely=0.315, anchor='center')
                e1.insert(0, rec2[1])

                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.375, anchor='center')
                e2 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e2.place(relx=0.53, rely=0.375, anchor='center')
                e2.insert(0, rec2[2])

                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.465, anchor='center')
                e3 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e3.place(relx=0.53, rely=0.465, anchor='center')
                e3.insert(0, rec2[3])

                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.525, anchor='center')
                e4 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e4.place(relx=0.53, rely=0.525, anchor='center')
                e4.insert(0, rec2[4])

                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.615, anchor='center')
                e5 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e5.place(relx=0.53, rely=0.615, anchor='center')
                e5.insert(0, rec2[5])

                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.675, anchor='center')
                e6 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e6.place(relx=0.53, rely=0.675, anchor='center')
                e6.insert(0, rec2[6])

                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.765, anchor='center')
                e7 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e7.place(relx=0.53, rely=0.765, anchor='center')
                e7.insert(0, rec2[7])

                lb(f10, image=p44, bd=0).place(
                    relx=0.53, rely=0.825, anchor='center')
                e8 = ent(f10, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 15), width=3)
                e8.place(relx=0.53, rely=0.825, anchor='center')
                e8.insert(0, rec2[8])

                def marks_save():
                    mget = [e1.get(), e2.get(), e3.get(), e4.get(),
                ...
                b34 = bt(f10, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                         fg='#249ADF', activebackground='#000000', command=marks_save)
                b34.place(relx=0.95, rely=0.0875, anchor='center')
                ANIMATE(b34, p51)

                b35 = bt(f10, image=p52, bd=0, font=('sf pro display', 15),
                         bg='#000000', fg='#CF3327', activebackground='#000000', command=marks)
                b35.place(relx=0.85, rely=0.0875, anchor='center')
                ANIMATE(b35, p52)

            b33 = bt(f10, image=p28, bd=0, bg='#000000',
                     activebackground='#000000', command=marks_edit)
    ...
    def fee_details():  # COMPLETED  ####################################################################
        ...
        if (sid.get(),) in d13:
            ...
            l81 = lb(f11, text='Fee details', font=('SF Pro Display',
                                                    38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
            ...
            dbcur.execute(
                'select * from fees where sid="{}"'.format(sid.get()))
            global d14
            ...
            l99 = lb(f11, text=it, font=('SF Pro Display', 32,
                                         'bold'), bd=0, bg='#232323', fg='#FFFFFF')
            ...
            if d14[3] == 'Paid' or d14[3] == 'paid':
                ...
                l92 = lb(f11, text='Cycle  :', font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
                l92.place(relx=0.2, rely=0.25, anchor='w')

                l93 = lb(f11, text='Amount  :', font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
                l93.place(relx=0.2, rely=0.35, anchor='w')

                l94 = lb(f11, text='Status  :', font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
                l94.place(relx=0.2, rely=0.45, anchor='w')

                l100 = lb(f11, text='Due date  :', font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
                l100.place(relx=0.2, rely=0.55, anchor='w')

                l95 = lb(f11, text=d14[1], font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
                l95.place(relx=0.35, rely=0.25, anchor='w')

                if d14[2] != 'N/A':
                    l96 = lb(f11, text=(
                        'Rs. '+d14[2]+'/-'), font=('SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
                    l96.place(relx=0.35, rely=0.35, anchor='w')
                else:
                    l96 = lb(f11, text=d14[2], font=(
                        'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
                    l96.place(relx=0.35, rely=0.35, anchor='w')

                l97 = lb(f11, text=d14[3], font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
                l97.place(relx=0.35, rely=0.45, anchor='w')

                l101 = lb(f11, text=d14[4], font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
            ...
            def fee_edit():
                ...
                la2 = lb(f11, text='Amount  :', font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
                la2.place(relx=0.2, rely=0.35, anchor='w')

                la3 = lb(f11, text='Status  :', font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
                la3.place(relx=0.2, rely=0.45, anchor='w')

                la8 = lb(f11, text='Due date  :', font=(
                    'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
                ...
                cy = ent(f11, bd=0, font=('SF Pro Display', 15),
                         width=10, bg='#F2F2F2')
                cy.place(relx=0.45, rely=0.25, anchor='center')
                cy.insert(0, d14[1])

                amt = ent(f11, bd=0, font=('SF Pro Display', 15),
                          width=10, bg='#F2F2F2')
                amt.place(relx=0.45, rely=0.35, anchor='center')
                amt.insert(0, d14[2])

                st = ent(f11, bd=0, font=('SF Pro Display', 15),
                         width=10, bg='#F2F2F2')
                st.place(relx=0.45, rely=0.45, anchor='center')
                st.insert(0, d14[3])

                dd = ent(f11, bd=0, font=('SF Pro Display', 15),
                         width=10, bg='#F2F2F2')
                ...
                m2 = msg(f11, text=tx1, bd=0, bg='#232323',
                         fg='#FFFFFF', font=('SF Pro Display', 11), width=800)
                ...
                b37 = bt(f11, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                         fg='#249ADF', activebackground='#000000', command=fee_save)
                b37.place(relx=0.95, rely=0.0875, anchor='center')
                ANIMATE(b37, p51)

                b38 = bt(f11, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                         fg='#CF3327', activebackground='#000000', command=fee_details)
                b38.place(relx=0.85, rely=0.0875, anchor='center')
                ANIMATE(b38, p52)

            b36 = bt(f11, image=p28, bd=0, bg='#000000',
                     activebackground='#000000', command=fee_edit)
    ...
    def events():  # COMPLETED ###############################################################
        ...
        la9 = lb(f14, text='Events', font=('SF Pro Display',
                                           38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
        ...
        lm1 = msg(f14, text=d15[0][1].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 10))
        lm1.place(relx=0.085, rely=0.335, anchor='w', height=55)

        lm2 = msg(f14, text=d15[1][1].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 10))
        lm2.place(relx=0.085, rely=0.471, anchor='w', height=55)

        lm3 = msg(f14, text=d15[2][1].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 10))
        lm3.place(relx=0.085, rely=0.607, anchor='w', height=55)

        lm4 = msg(f14, text=d15[3][1].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 10))
        lm4.place(relx=0.085, rely=0.745, anchor='w', height=55)

        lm5 = msg(f14, text=d15[4][1].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 10))
        lm5.place(relx=0.085, rely=0.883, anchor='w', height=55)

        ### DATES ###

        lb2 = lb(f14, text=d15[0][2], bd=0, bg='#404040',
                 fg='#FFFFFF', font=('SF Pro Display', 10))
        lb2.place(relx=0.775, rely=0.335, anchor='w')

        lb3 = lb(f14, text=d15[1][2], bd=0, bg='#404040',
                 fg='#FFFFFF', font=('SF Pro Display', 10))
        lb3.place(relx=0.775, rely=0.471, anchor='w')

        lb4 = lb(f14, text=d15[2][2], bd=0, bg='#404040',
                 fg='#FFFFFF', font=('SF Pro Display', 10))
        lb4.place(relx=0.775, rely=0.607, anchor='w')

        lb5 = lb(f14, text=d15[3][2], bd=0, bg='#404040',
                 fg='#FFFFFF', font=('SF Pro Display', 10))
        lb5.place(relx=0.775, rely=0.745, anchor='w')

        lb6 = lb(f14, text=d15[4][2], bd=0, bg='#404040',
                 fg='#FFFFFF', font=('SF Pro Display', 10))
        ...
        def events_edit():
            ...
            def events_save():
                ...
                b = 0
                c = 0
                eget = [ta1.get(1.0, END), ta2.get(1.0, END), ta3.get(
                    1.0, END), ta4.get(1.0, END), ta5.get(1.0, END)]
            ...
            b46 = bt(f14, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                     fg='#249ADF', activebackground='#000000', command=events_save)
            b46.place(relx=0.95, rely=0.0865, anchor='center')
            ANIMATE(b46, p51)

            b47 = bt(f14, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                     fg='#CF3327', activebackground='#000000', command=events)
            b47.place(relx=0.85, rely=0.0865, anchor='center')
            ANIMATE(b47, p52)

        b45 = bt(f14, image=p28, bd=0, bg='#000000',
                 activebackground='#000000', command=events_edit)
    ...
    def attendance():  # COMPLETED  ##########################################################
        ...
        if (sid.get(),) in d16:
            ...
            lb7 = lb(f15, text='Attendance', font=('SF Pro Display',
                                                   38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
            ...
            dbcur.execute(
                'select * from attendance where sid="{}"'.format(sid.get()))
            global d17
            d17 = dbcur.fetchall()[0]

            lb9 = lb(f15, text='Number of days present  :', font=(
                'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
            lb9.place(relx=0.2, rely=0.2, anchor='w')

            lc1 = lb(f15, text='Total number of days  :', font=(
                'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
            lc1.place(relx=0.2, rely=0.275, anchor='w')

            lc2 = lb(f15, text=d17[1], font=(
                'SF Pro Display', 16), bd=0, bg='#232323', fg='#249ADF')
            lc2.place(relx=0.55, rely=0.2, anchor='w')

            lc4 = lb(f15, text='180', font=('SF Pro Display', 16),
                     bd=0, bg='#232323', fg='#FFFFFF')
            lc4.place(relx=0.55, rely=0.275, anchor='w')

            lc5 = lb(f15, text='Status  :', font=(
                'SF Pro Display', 16), bd=0, bg='#232323', fg='#FFFFFF')
            lc5.place(relx=0.2, rely=0.35, anchor='w')

            lc6 = lb(f15, text='N/A', font=('SF Pro Display', 16),
                     bd=0, bg='#232323', fg='#FFFFFF')
            ...
            if d17[1] != 'NULL' and d17[1] != None:
                ...
                c1 = cv(f15, width=230, height=230, bd=0,
                        bg='#232323', highlightbackground='#232323')
                arc = 20, 20, 230, 230
                pr = int(d17[1])
                ab = 180-(pr)

                c1.create_arc(arc, start=-60, extent="{}".format(-ab),
                              fill='#FF5757', outline='#FF5757')  # absent right
                c1.create_arc(arc, start=0, extent="{}".format(
                    pr), fill='#8C52FF', outline='#8C52FF')  # present right
                # holidays (festivals + weekends)
                c1.create_arc(arc, start="{}".format(
                    pr), extent=120, fill='#C9E265', outline='#C9E265')
                c1.create_arc(arc, start=0, extent=-60, fill='#FF914D',
                              outline='#FF914D')  # permitted leaves
            ...
            def att_edit():
                ...
                at = ent(f15, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 14), width=3)
                ...
                b49 = bt(f15, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                         fg='#249ADF', activebackground='#000000', command=att_save)
                b49.place(relx=0.95, rely=0.0875, anchor='center')
                ANIMATE(b49, p51)

                b50 = bt(f15, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                         fg='#CF3327', activebackground='#000000', command=attendance)
                b50.place(relx=0.85, rely=0.0875, anchor='center')
                ANIMATE(b50, p52)

            b48 = bt(f15, image=p28, bd=0, bg='#000000',
                     activebackground='#000000', command=att_edit)
    ...
    def projects():  # COMPLETED  #########################################################
        ...
        if (sid.get(),) in d18:
            ...
            lc8 = lb(f16, text='Projects', font=('SF Pro Display',
                                                 38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
            ...
            dbcur.execute(
                'select t1,t2,t3,t4,t5 from projects where sid="{}"'.format(sid.get()))
            ...
            def projects_edit():
                ...
                def projects_save():
                    ...
                    b = 0
                    c = 0
                    pro = [ta6.get(1.0, END).strip(), ta7.get(1.0, END).strip(), ta8.get(
                        1.0, END).strip(), ta9.get(1.0, END).strip(), ta10.get(1.0, END).strip()]
                    dates = [tb6.get().strip(), tb7.get().strip(), tb8.get(
                    ).strip(), tb9.get().strip(), tc1.get().strip()]
                    for h in pro:
                        if h == '':
                            a += 1
                    for i in dates:
                ...
                b52 = bt(f16, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                         fg='#249ADF', activebackground='#000000', command=projects_save)
                b52.place(relx=0.95, rely=0.0875, anchor='center')
                ANIMATE(b52, p51)

                b53 = bt(f16, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                         fg='#CF3327', activebackground='#000000', command=projects)
                b53.place(relx=0.85, rely=0.0875, anchor='center')
                ANIMATE(b53, p52)

            b51 = bt(f16, image=p28, bd=0, bg='#000000',
                     activebackground='#000000', command=projects_edit)
    ...
    def assignments():  # COMPLETED  #############################################################
        ...
        if (sid.get(),) in d18:
            ...
            ld5 = lb(f17, text='Assignments', font=('SF Pro Display',
                                                    38, 'bold'), bd=0, bg='#000000', fg='#FFFFFF')
            ...
            dbcur.execute(
                'select a1,a2,a3,a4,a5 from assignments where sid="{}"'.format(sid.get()))
            d19 = dbcur.fetchall()[0]
            assi = []
            adate = []
            sdate = []
            ...
            def assignment_edit():
                ...
                lb(f17, image=p46, bd=0).place(
                    relx=0.6275, rely=0.34, anchor='center')
                a6 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                a6.place(relx=0.6275, rely=0.34, anchor='center')
                a6.insert(0, adate[0])

                lb(f17, image=p46, bd=0).place(
                    relx=0.6275, rely=0.473, anchor='center')
                a7 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                a7.place(relx=0.6275, rely=0.473, anchor='center')
                a7.insert(0, adate[1])

                lb(f17, image=p46, bd=0).place(
                    relx=0.6275, rely=0.612, anchor='center')
                a8 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                a8.place(relx=0.6275, rely=0.612, anchor='center')
                a8.insert(0, adate[2])

                lb(f17, image=p46, bd=0).place(
                    relx=0.6275, rely=0.75, anchor='center')
                a9 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                a9.place(relx=0.6275, rely=0.75, anchor='center')
                a9.insert(0, adate[3])

                lb(f17, image=p46, bd=0).place(
                    relx=0.6275, rely=0.89, anchor='center')
                c1 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                ...
                lb(f17, image=p46, bd=0).place(
                    relx=0.8365, rely=0.34, anchor='center')
                c2 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                c2.place(relx=0.8365, rely=0.34, anchor='center')
                c2.insert(0, sdate[0])

                lb(f17, image=p46, bd=0).place(
                    relx=0.8365, rely=0.473, anchor='center')
                c3 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                c3.place(relx=0.8365, rely=0.473, anchor='center')
                c3.insert(0, sdate[1])

                lb(f17, image=p46, bd=0).place(
                    relx=0.8365, rely=0.612, anchor='center')
                c4 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                c4.place(relx=0.8365, rely=0.612, anchor='center')
                c4.insert(0, sdate[2])

                lb(f17, image=p46, bd=0).place(
                    relx=0.8365, rely=0.75, anchor='center')
                c5 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                c5.place(relx=0.8365, rely=0.75, anchor='center')
                c5.insert(0, sdate[3])

                lb(f17, image=p46, bd=0).place(
                    relx=0.8365, rely=0.89, anchor='center')
                c6 = ent(f17, bd=0, bg='#F2F2F2', font=(
                    'SF Pro Display', 16), width=10)
                c6.place(relx=0.8365, rely=0.89, anchor='center')
                c6.insert(0, sdate[4])

                def assignment_save():
                    a1get = [a1.get(1.0, END).strip(), a2.get(1.0, END).strip(), a3.get(
                        1.0, END).strip(), a4.get(1.0, END).strip(), a5.get(1.0, END).strip()]
                    adget = [a6.get().strip(), a7.get().strip(), a8.get(
                    ).strip(), a9.get().strip(), c1.get().strip()]
                    sget = [c2.get().strip(), c3.get().strip(), c4.get(
                    ).strip(), c5.get().strip(), c6.get().strip()]
                    g = 0
                    z = 0
                    p = 0
                    for x in range(5):
                ...
                b55 = bt(f17, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                         fg='#249ADF', activebackground='#000000', command=assignment_save)
                b55.place(relx=0.95, rely=0.0875, anchor='center')
                ANIMATE(b55, p51)

                b56 = bt(f17, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                         fg='#CF3327', activebackground='#000000', command=assignments)
                b56.place(relx=0.85, rely=0.0875, anchor='center')
                ANIMATE(b56, p52)

            b54 = bt(f17, image=p28, bd=0, bg='#000000',
                     activebackground='#000000', command=assignment_edit)
    ...
    def about():  # COMPLETED    ###############################################
        ...
        m1 = msg(f6, text=d7.strip(), bd=0, bg='#232323',
                 fg='#FFFFFF', font=('SF Pro Display', 12))
        m1.place(relx=0.5, rely=0.55, anchor='center', width=750, height=400)

        l26 = lb(f6, text='About', font=('SF Pro Display', 38,
                                         'bold'), bd=0, bg='#000000', fg='#FFFFFF')
        ...
        def about_edit():
            ...
            t1 = tx(f6, bd=0, bg='#232323', fg='#FFFFFF', font=(
                'SF Pro Display', 12), padx=80, pady=10)
            ...
            def abt_save():
                if t1.get(1.0, END).strip() == '':
                    ...
                    try:
                        dbcur.execute(
                            'update about set text="{}"'.format(t1.get(1.0, END)))
                        dbcon.commit()
                        about()
                    except:
                        msgb.showinfo('Unexpected error',
            ...
            b21 = bt(f6, image=p51, bd=0, font=('SF Pro Display', 15), bg='#000000',
                     fg='#249ADF', activebackground='#000000', command=abt_save)
            b21.place(relx=0.95, rely=0.0875, anchor='center')
            ANIMATE(b21, p51)

            b22 = bt(f6, image=p52, bd=0, font=('sf pro display', 15), bg='#000000',
                     fg='#CF3327', activebackground='#000000', command=about)
            b22.place(relx=0.85, rely=0.0875, anchor='center')
            ANIMATE(b22, p52)

        b20 = bt(f6, image=p28, bd=0, bg='#000000',
                 activebackground='#000000', command=about_edit)
...
#############################################################         STUDENT SIDE        ###########################################################
    ...
    def studenthome():  # COMPLETED  #############################################################
        ...
        b7 = bt(f4, image=p11, bd=0, bg='#000000',
                activebackground='#000000', command=sprofile1)  # profile
        b7.place(relx=0.1385, rely=0.236, anchor='center')
        ANIMATE(b7, p11)

        b8 = bt(f4, image=p12, bd=0, bg='#000000',
                activebackground='#000000', command=assignments1)  # assignments
        b8.place(relx=0.466, rely=0.688, anchor='center')
        ANIMATE(b8, p12)

        b9 = bt(f4, image=p14, bd=0, bg='#000000',
                activebackground='#000000', command=projects1)  # projects
        b9.place(relx=0.392, rely=0.182, anchor='center')
        ANIMATE(b9, p14)

        b10 = bt(f4, image=p18, bd=0, bg='#000000',
                 activebackground='#000000', command=marks1)  # marks
        b10.place(relx=0.7515, rely=0.182, anchor='center')
        ANIMATE(b10, p18)

        b11 = bt(f4, image=p16, bd=0, bg='#000000',
                 activebackground='#000000', command=attendance1)  # attendance
        b11.place(relx=0.13855, rely=0.62, anchor='center')
        ANIMATE(b11, p16)

        b12 = bt(f4, image=p15, bd=0, bg='#000000',
                 activebackground='#000000', command=events1)  # events
        b12.place(relx=0.13855, rely=0.8825, anchor='center')
        ANIMATE(b12, p15)

        b13 = bt(f4, image=p19, bd=0, bg='#000000',
                 activebackground='#000000', command=passr1)  # passreset
        b13.place(relx=0.738, rely=0.52, anchor='center')
        ANIMATE(b13, p19)

        b14 = bt(f4, image=p17, bd=0, bg='#000000',
                 activebackground='#000000', command=about1)  # about
        b14.place(relx=0.912, rely=0.52, anchor='center')
        ANIMATE(b14, p17)

        b15 = bt(f4, image=p13, bd=0, bg='#000000',
                 activebackground='#000000', command=fee_details1)  # fee
        b15.place(relx=0.8263, rely=0.828, anchor='center')
        ANIMATE(b15, p13)

        b16 = bt(f3, image=p20, bd=0, bg='#232323', activebackground='#232323',
                 command=studenthome)  # studenthome button
        b16.place(relx=0.5, rely=0.75, anchor='center')
        ANIMATE(b16, p20)

        dbcur.execute(
            'select sname from sprofile where sid="{}" '.format(stid.get()))
        gr = dbcur.fetchall()
        msgl = ['Hi !', 'Hey !', 'Bonjour !']
        greeting = choice(msgl)+'  '+(gr[0][0].split())[0]

        l12 = lb(f3, text=greeting, font=('SF Pro Display', 18),
                 bd=0, bg='#232323', fg='#FFFFFF')
        l12.place(relx=0.275, rely=0.75, anchor='center')
    ...
    def passr1():  # COMPLETE  #############################################################
        def spassreset1():
            ...
            def spass_save():
                dbcur.execute(
                    'select pass from slogin where id="{}"'.format(stid.get()))
                d5 = dbcur.fetchall()
                try:
    ...
    def sprofile1():  # COMPLETE   ##################################################
        ...
        dbcur.execute(
            'select * from sprofile where sid="{}"'.format(stid.get()))
        d6 = dbcur.fetchall()
        rec = d6[0]
    ...
    def marks1():  # COMPLETE   ##################################################
        ...
        if rec1[1] != 'NULL':
            ...
            l77 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')  # mid sem 1
            l77.place(relx=0.53, rely=0.315, anchor='center')

            l78 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')
            l78.place(relx=0.82, rely=0.315, anchor='center')
        ...
        if rec1[2] != 'NULL':
            ...
            l79 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')  # sem final 1
            l79.place(relx=0.53, rely=0.375, anchor='center')

            l80 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')
            l80.place(relx=0.82, rely=0.375, anchor='center')
        ...
        if rec1[3] != 'NULL':
            ...
            l65 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')  # midsem 2
            l65.place(relx=0.53, rely=0.465, anchor='center')
        ...
        if rec1[6] != 'NULL':
            ...
            l71 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')  # final 3
            l71.place(relx=0.53, rely=0.675, anchor='center')

            l72 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')
            l72.place(relx=0.82, rely=0.675, anchor='center')
        ...
        if rec1[7] != 'NULL':
            ...
            l73 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')  # midsem 4
            l73.place(relx=0.53, rely=0.765, anchor='center')

            l74 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')
            l74.place(relx=0.82, rely=0.765, anchor='center')
        ...
        if rec1[8] != 'NULL':
            ...
            l75 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')  # final 4
            l75.place(relx=0.53, rely=0.825, anchor='center')

            l76 = lb(f10, text='N/A', bd=0, font=('SF Pro Display', 15),
                     bg='#232323', fg='#FFFFFF')
            l76.place(relx=0.82, rely=0.825, anchor='center')
    ...
    def fee_details1():  # COMPLETED  ####################################################################
        ...
        l98 = lb(f11, image=im, bd=0)
        l99 = lb(f11, text=it, font=('SF Pro Display', 32, 'bold'),
                 bd=0, bg='#232323', fg='#FFFFFF')
        ...
        if d14[3] == 'Paid' or d14[3] == 'paid':
            ...
            l92 = lb(f11, text='Cycle  :', font=('SF Pro Display', 16),
                     bd=0, bg='#232323', fg='#249ADF')
            l92.place(relx=0.2, rely=0.25, anchor='w')
            ...
            tx1 = ('* The cycle can be any time period, it may be represented as semesters or even dates.\n'
                   ...
                   'such as PayTM, our online portal, Net banking, etc.\n'
                   '* Funds once transferred can in no way be refunded, instead it may be adjusted in future transactions.\n')
            m2 = msg(f11, text=tx1, bd=0, bg='#232323', fg='#FFFFFF',
                     font=('SF Pro Display', 11), width=800)
            m2.place(relx=0.5, rely=0.8, anchor='center')
    ...
    def attendance1():  # COMPLETED  ##########################################################
        ...
        dbcur.execute(
            'select * from attendance where sid="{}"'.format(stid.get()))
        global d17
        d17 = dbcur.fetchall()[0]
        ...
        lc5 = lb(f15, text='Status  :', font=('SF Pro Display', 16),
                 bd=0, bg='#232323', fg='#FFFFFF')
        lc5.place(relx=0.2, rely=0.35, anchor='w')
        ...
        if d17[1] != 'NULL' and d17[1] != None:
            ...
            c1.create_arc(arc, start=0, extent="{}".format(
                pr), fill='#8C52FF', outline='#8C52FF')  # present right
            c1.create_arc(arc, start="{}".format(pr), extent=120, fill='#C9E265',
                          outline='#C9E265')  # holidays (festivals + weekends)
            c1.create_arc(arc, start=0, extent=-60, fill='#FF914D',
                          outline='#FF914D')  # permitted leaves
            c1.place(relx=0.35, rely=0.65, anchor='center')
    ...
    def projects1():  # COMPLETED  #########################################################
        ...
        dbcur.execute(
            'select t1,t2,t3,t4,t5 from projects where sid="{}"'.format(stid.get()))
        d19 = dbcur.fetchall()[0]
        proj = []
        date1 = []
        for g in d19:
        ...
        lm6 = msg(f16, text=proj[0].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        lm6.place(relx=0.35, rely=0.348, anchor='center', height=55)

        lm7 = msg(f16, text=proj[1].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        lm7.place(relx=0.35, rely=0.484, anchor='center', height=55)

        lm8 = msg(f16, text=proj[2].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        lm8.place(relx=0.35, rely=0.62, anchor='center', height=55)

        lm9 = msg(f16, text=proj[3].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        lm9.place(relx=0.35, rely=0.758, anchor='center', height=55)

        ln1 = msg(f16, text=proj[4].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        ln1.place(relx=0.35, rely=0.896, anchor='center', height=55)
    ...
    def assignments1():  # COMPLETED  #############################################################
        ...
        dbcur.execute(
            'select a1,a2,a3,a4,a5 from assignments where sid="{}"'.format(stid.get()))
        d19 = dbcur.fetchall()[0]
        assi = []
        adate = []
        sdate = []
        ...
        ln2 = msg(f17, text=assi[0].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        ln2.place(relx=0.29, rely=0.34, anchor='center', height=55)

        ln3 = msg(f17, text=assi[1].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        ln3.place(relx=0.29, rely=0.473, anchor='center', height=55)

        ln4 = msg(f17, text=assi[2].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        ln4.place(relx=0.29, rely=0.612, anchor='center', height=55)

        ln5 = msg(f17, text=assi[3].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        ln5.place(relx=0.29, rely=0.75, anchor='center', height=55)

        ln6 = msg(f17, text=assi[4].strip(), bd=0, bg='#404040',
                  fg='#FFFFFF', width=525, font=('SF Pro Display', 16))
        ln6.place(relx=0.29, rely=0.89, anchor='center', height=55)
    ...
    def adlogin():  # COMPLETE #####################################################################
        ...
        l3 = lb(f1, text='ID', bg='#232323',
                fg='#FFFFFF', font=('SF Pro Display', 15))
        l3.place(relx=0.64, rely=0.54, anchor='center')

        l4 = lb(f1, text='Password', bg='#232323',
                fg='#FFFFFF', font=('SF Pro Display', 15))
        ...
        def adverify():
            ...
            for i in d8:
                if aid.get() == i[0]:
                    dbcur.execute(
                        'select pass from adminlogin where id="{}"'.format(aid.get()))
                    d9 = dbcur.fetchall()
                    if key.get() == d9[0][0]:
                        adminhome()
        ...
        b3 = bt(f1, image=p7, bd=0, bg='#232323',
                activebackground='#232323', command=adverify)
        ...
        b5 = bt(f1, image=p8, bd=0, bg='#000000',
                activebackground='#000000', command=main)
    ...
    def stlogin():
        ...
        b3 = bt(f1, image=p7, bd=0, bg='#232323',
                activebackground='#232323', command=stverify)
        b3.place(relx=0.85, rely=0.69, anchor='center')
        ANIMATE(b3, p7)
    ...
    def main():  # COMPLETE  ########################################################################
        ...
        l1 = lb(f1, text='Please Sign In.', bg='#000000',
                fg='#FFFFFF', font=('SF Pro Display', 38, 'bold'))
        l1.place(relx=0.75, rely=0.35, anchor='center')

        # login button 1

        global adminbt
        adminbt = bt(f1, image=p2, bd=0, bg='#000000',
                     activebackground='#000000', command=adlogin)
        adminbt.place(relx=0.75, rely=0.525, anchor='center')

        # login button 2

        global studentbt
        studentbt = bt(f1, image=p53, bd=0, bg='#000000',
                       activebackground='#000000', command=stlogin)
    ...
    try:
        dbcon = db.connect(host='localhost', user='root',
                           password='mysql', database='proj_vidul')
